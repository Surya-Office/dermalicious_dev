...
class User extends CI_Controller
{
    ...
    public function list_user()
    {
        ...
        foreach ($list as $user) {
            ...
            $row[] = "<button class='btn btn-info' onclick='getDetail(this)' data-id='".$user['id_user']."'><i class='fas fa-eye'></i></button>
                      <button class='btn btn-warning' onclick='getEdit(this)' data-id='".$user['id_user']."'><i class='fas fa-pencil-alt'></i></button>
                      <button onclick=deleteConfirm('".site_url().'master/user/DeleteUser/'.$user['id_user']."') class='btn btn-danger'><i class='fas fa-trash'></i></button>";
