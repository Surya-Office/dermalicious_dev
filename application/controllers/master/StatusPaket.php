...
final class StatusPaket extends CI_Controller
{
    ...
    public function list_status_paket()
    {
        ...
        foreach ($list as $status) {
            ...
            $row[] = "<button onclick='getEdit(this)' data-id='".$status['id_status_paket']."' class='btn btn-warning'><i class='fas fa-pencil-alt'></i></button>
                      <button onclick=deleteConfirm('".site_url().'master/StatusPaket/deleteStatusPaket/'.$status['id_status_paket']."') class='btn btn-danger'><i class='fas fa-trash'></i></button>";
