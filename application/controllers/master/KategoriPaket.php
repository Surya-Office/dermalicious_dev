...
final class KategoriPaket extends CI_Controller
{
    ...
    public function list_kategori_paket()
    {
        ...
        foreach ($list as $kategori) {
            ...
            $row[] = "<button onclick='getEdit(this)' data-id='".$kategori['id_kategori_paket']."' class='btn btn-warning'><i class='fas fa-pencil-alt'></i></button>
                      <button onclick=deleteConfirm('".site_url().'master/KategoriPaket/deleteKategoriPaket/'.$kategori['id_kategori_paket']."') class='btn btn-danger'><i class='fas fa-trash'></i></button>";
