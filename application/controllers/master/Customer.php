...
class Customer extends CI_Controller
{
    ...
    public function list_customer()
    {
        ...
        foreach ($list as $cus) {
            ...
            $row[] = $cus['telepon_1'];
            $row[] = $cus['telepon_2'];
            $row[] = "<button class='btn btn-warning' onclick='getEdit(this)' data-id='".$cus['id_customer']."'><i class='fas fa-pencil-alt'></i></button>
                      <button onclick=deleteConfirm('".site_url().'master/customer/Delete/'.$cus['id_customer']."') class='btn btn-danger'><i class='fas fa-trash'></i></button>";
