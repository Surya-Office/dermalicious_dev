...
final class Holiday extends CI_Controller
{
    ...
    function list_holiday() {
        ...
        foreach ($list as $holiday) {
            ...
            $row[] = "<button class='btn btn-info' onclick='getDetail(this)' data-id='".$holiday['id_holiday']."'><i class='fas fa-eye'></i></button>
                      <button class='btn btn-warning' onclick='getEdit(this)' data-id='".$holiday['id_holiday']."'><i class='fas fa-pencil-alt'></i></button>
                      <button onclick=deleteConfirm('".site_url().'master/Holiday/DeleteHoliday/'.$holiday['id_holiday']."') class='btn btn-danger'><i class='fas fa-trash'></i></button>";
                            ...
                            <div class="col-md-12">
                                ...
                                <label>Date Holiday</label>
                                    <div class="input-group date" id="tgl-addholiday" data-target-input="nearest">
                                        <input type="text" class="form-control datetimepicker-input" value="'.$get_holiday->date_holiday.'" name="date_holiday" data-target="#tgl-addholiday" />
