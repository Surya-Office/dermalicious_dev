...
final class Brand extends CI_Controller
{
    ...
    public function list_brand()
    {
        ...
        foreach ($list as $brand) {
            ...
            $row[] = $brand['nama'];
            $row[] = "<button class='btn btn-info' onclick='getDetail(this)' data-id='".$brand['id_perusahaan']."'><i class='fas fa-eye'></i></button>
                      <button class='btn btn-warning' onclick='getEdit(this)' data-id='".$brand['id_perusahaan']."'><i class='fas fa-pencil-alt'></i></button>
                      <button onclick=deleteConfirm('".site_url().'master/brand/Deletebrand/'.$brand['id_perusahaan']."') class='btn btn-danger'><i class='fas fa-trash'></i></button>";
