                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true"
                            aria-expanded="false" class="nav-link dropdown-toggle">Hai, $UserNAME</a>
            ...
            <div class="content-wrapper" style="margin-left : auto">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1>Create Master Jenis Paket</h1>
                            </div><!-- /.col -->
                            <div class="col-sm-4">
                                <div class="button-create">
                                    <a href="<?=site_url('master/jenispaket')?>" class="btn btn-primary" role="button"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 text-right">
                                            <a href="msjenis-paket.html" button type="button"
