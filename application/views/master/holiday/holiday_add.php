    ...
    <div class="content-wrapper" style="margin-left : auto">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-8">
              <h1>Create Master Holiday</h1>
            </div><!-- /.col -->
            <div class="col-sm-4">
              <div class="button-create">
                <a href="<?=site_url('master/holiday')?>" class="btn btn-primary" role="button" style="margin-left: -12px;"> <i
                    class="fas fa-reply">
                  </i>
                </a>
              </div>
            ...
            <div class="card-header">
              ...
              <div class="row">
                <div class="col-md-12 text-right">
                  <a href="<?=site_url('master/holiday')?>" button type="button" class="btn btn-outline-success"
