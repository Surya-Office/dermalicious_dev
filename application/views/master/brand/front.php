...
<!-- Navbar -->
          ...
          <div class="card card-default">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select class="form-control select2" style="width: 100%;">
                        ...
                        <option>PT Megah Estetika Perkasa</option>
                        <option>PT Samudera Estetika Perkasa</option>
                      </select>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <select class="form-control select2" style="width: 100%;">
                        <option selected="selected"></option>
                        <option>Dermaster</option>
                        <option>Derma Express</option>
                      </select>
                    </div>
                  </div>
                </div>
            ...
            <div class="row">
              <div class="col-12" style="padding: 20px;">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Master Perusahaan Detail</h3>
      ...
      <div class="modal fade" id="modal-create">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <form action="<?=site_url('master/Brand/insertBrand/')?>" method="post" rnctype="multipart/form-data">
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function() {
          ...
          table = $('#brand-table').DataTable({
              ...
              "ajax": {
                  "url": "<?=site_url('master/brand/list_brand')?>",
                  "type": "POST"
              },
    ...
    <script>
      function getEdit(id_user) {
        ...
        // alert(id);
        $.ajax({  
            url : "<?=site_url('master/brand/EditBrand') ?>", 
            type:"POST",  
            data:{id_brand:id},  
      ...
      function getDetail(id_user) {
        ...
        // alert(id);
        $.ajax({  
            url : "<?=site_url('master/brand/DetailBrand') ?>", 
            type:"POST",  
            data:{id_brand:id},  
            success:function(data){
            //alert(data);  
