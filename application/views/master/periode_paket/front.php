          ...
          <div class="card card-default">
            ...
            <div class="row">
              <div class="col-12" style="padding: 20px;">
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title">Master Periode Paket Detail</h3>
                  ...
                  <!-- /.card-header -->
                  <div class="card-body">
                    <table id="periode-table" class="table table-bordered table-hover">
                      <thead>
                        <tr>
                          <th>ID Periode Paket</th>
                          <th>Periode Paket</th>
                          <th>Action</th>
                        </tr>
                      </thead>
                        ...
                        <!-- <tr>
                          ...
                          <td>
                            <div class="btn-group btn-group-xs">
                              <a href="msperiode-paket-edit.html" class="btn btn-warning" data-toggle="tooltip"
    ...
    <div class="modal fade" id="modal-create">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Add Periode Paket</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <form action="<?=site_url('master/PeriodePaket/insert/')?>" method="post" rnctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Periode Paket</label>
                                    <input class="form-control" name="periode_paket" type="text">
                                </div>
      ...
      <div class="modal fade" id="modal-edit">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title">Edit Periode Paket</h4>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function() {
          ...
          table = $('#periode-table').DataTable({
              ...
              "ajax": {
                  "url": "<?=site_url('master/PeriodePaket/list_periode_paket')?>",
                  "type": "POST"
              },
...
<script>
      function getEdit(id) {
        ...
        // alert(id);
        $.ajax({  
            url : "<?=site_url('master/PeriodePaket/Edit') ?>", 
            type:"POST",  
            data:{id:id},  
      ...
      function getDetail(id) {
        ...
        // alert(id);
        $.ajax({  
            url : "<?=site_url('master/PeriodePaket/DetailPeriodePaket') ?>", 
            type:"POST",  
            data:{id:id},  
            success:function(data){
            //alert(data);  
