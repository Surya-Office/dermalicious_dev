                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="3" name="riwayat_alergi" readonly><?=$detail_transaksi->riwayat_alergi?></textarea>
                          ...
                          <div class="row">
                            <div class="col-lg-6 col-sm-12">
                              ...
                              <label class="my-1 d-flex align-items-center">Google Maps <span class="ml-auto"><i class="fas fa-search-location"></i></span></label>
                                ...
                                <input class="form-control form-control-lg" type="hidden" name="linkmaps_3" value="<?=$detail_transaksi->maps_3?>" id="link-maps-3">
                              </div>
                              <!-- <input class="form-control form-control-lg" type="text" placeholder=""
                                style="height: 80px;"> -->
                            </div>
