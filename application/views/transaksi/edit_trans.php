                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label>ID User</label>
                          <input class="form-control" value="<?=$transaksi->id_user?>" readonly type="text" name="id_user">
                        </div>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select class="form-control select2" name="status_paket" style="width: 100%;">
                            <option value="<?=$transaksi->status_paket?>"><?=$transaksi->status_paket?></option>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input class="form-control" value="<?=$transaksi->id_transaksi?>" readonly name="id_transaksi" type="text">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <select class="form-control select2" id="perusahaan" name="brand" style="width: 100%;">
                            <option value="<?=$transaksi->id_perusahaan?>"><?=$transaksi->nama?></option>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <option value="<?=$transaksi->id_klinik?>"><?=$transaksi->nama_klinik?></option>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label>ID Customer</label>
                            <input class="form-control" name="id_customer" type="text" value="<?=$transaksi->id_customer?>" readonly>
                          </select>
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input class="form-control" name="nama_customer" value="<?=$transaksi->nama_customer?>" id="nama_customer" type="text" placeholder="">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label>Nomer Whatsapp<span style="color:red">*</span></label>
                            ...
                            <input class="form-control" name="telp_1" maxlength="13" value="<?=$transaksi->telepon_1?>" onkeypress="return hanyaAngka(event)" type="text" placeholder="">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input class="form-control" name="telp_2" maxlength="13" onkeypress="return hanyaAngka(event)" type="text" value="<?=$transaksi->telepon_2?>" placeholder="">
                        </div>
                      </div>
                    </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="text" name="waktu_trans" value="<?=date('H:i', strtotime($transaksi->tgl_transaksi))?>" readonly class="form-control">
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="form-group">
                          ...
                          <?php if ($transaksi->status_veryfied == "not verified") { ?>
                            <div class="input-group date" id="reservationdate2" data-target-input="nearest">
                              <input type="text" name="tgl_pembayaran" class="form-control datetimepicker-input" data-target="#reservationdate2" value="<?=date('d-m-Y', strtotime($transaksi->paid_date))?>" />
                              <div class="input-group-append" data-target="#reservationdate2" data-toggle="datetimepicker">
                                <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                              </div>
                            </div>
                          <?php } else {?>
                            <input type="text" name="tgl_pembayaran" readonly value="<?=date('d M Y', strtotime($transaksi->paid_date))?>" class="form-control">
                          <?php } ?>
                        </div>
                        <!-- /.form-group -->
                      </div>
                        ...
                        <div class="form-group">
                          ...
                          <?php if ($transaksi->status_veryfied == "not verified") { ?>
                            <div class="input-group date" id="timepicker2" data-target-input="nearest">
                              <input type="text" name="waktu_pembayaran" class="form-control datetimepicker-input" data-target="#timepicker2" value="<?=date('H:i', strtotime($transaksi->paid_date))?>"  />
                              <div class="input-group-append" data-target="#timepicker2" data-toggle="datetimepicker">
                                <div class="input-group-text"><i class="far fa-clock"></i></div>
                              </div>
                            </div>
                          <?php } else {?>
                            <input type="text" name="waktu_pembayaran" readonly value="<?=date('H:i', strtotime($transaksi->paid_date))?>" class="form-control">
                          <?php } ?>
                        </div>
                      </div>
                    </div>
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label>Status Verifikasi</label>
                            <input type="text" name="status_verifikasi" id="" class="form-control" value="<?=$transaksi->status_veryfied?>" readonly>
                        </div>
                      </div>
                    </div>
                    <div class="row">
                      ...
                      <div class="col-md-6">
                        <div class="form-group">
                          <label>Remarks</label>
                          <input class="form-control" name="remarks" value="<?=$transaksi->notes?>" type="text" placeholder="">
                        </div>
                      </div>
                    </div>
                              ...
                              foreach ($detail_transaksi as $key) {?>
                                ...
                                <td>
                                  <div class="btn-group btn-group-xs">
                                    ...
                                    <a href="<?=site_url('transaksi/editdetailtransaksi/'.$key['id_transaksi'].'/'.$key['id_transaksi_detail'])?>" class="btn btn-warning" data-toggle="tooltip" title="Edit"><i
