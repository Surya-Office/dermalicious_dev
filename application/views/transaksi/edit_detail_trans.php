                ...
                <div class="row">
                  ...
                  <div class="col-lg-6 col-sm-12">
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="10" name="notepengiriman_1" required value="<?=$detail_transaksi->note_pengiriman_1?>" style="height: 250px;"></textarea>
                    </div>
                  </div>
                </div>
                      ...
                      <div class="row">
                        <div class="col-lg-6 col-sm-12">
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-12">
                              <label>Catatan Pengiriman</label>
                              <textarea class="form-control" name="notepengiriman_2" value="<?=$detail_transaksi->note_pengiriman_2?>" style="height: 250px;"></textarea>
                            </div>
                          </div>
                        ...
                        <div class="col-lg-6 col-sm-12">
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-6 col-sm-12">
                              <div class="form-group">
                                <label>Catatan Pengiriman</label>
                                <textarea class="form-control" rows="10" name="notepengiriman_3" value="<?=$detail_transaksi->note_pengiriman_3?>" style="height: 250px;"></textarea>
                              </div>
                            </div>
                          </div>
