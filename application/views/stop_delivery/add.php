                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="input-group date" id="reservationdate" data-target-input="nearest">
                          <input type="text" name="start_hold" class="form-control datetimepicker-input" data-target="#reservationdate" />
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="input-group date" id="endholddelivery" data-target-input="nearest">
                          <input type="text" name="end_hold" class="form-control datetimepicker-input" data-target="#endholddelivery" />
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="input-group date" id="restartdelivery" name="restart_date" data-target-input="nearest">
                          <input type="text" class="form-control datetimepicker-input" data-target="#restartdelivery" />
