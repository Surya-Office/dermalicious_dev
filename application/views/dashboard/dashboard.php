...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper" style="margin-left : auto; background-color: white;">
            <div class="bg-image"
                style="background-image: url('https://test.ayrusp.com/assets/dist/img/pattern3.jpg'); height: 100vh">
                ...
                <div class="content-header" style="display: flex;">
                    <div class="container-fluid d-none d-sm-block">
                        <div class="row">
                            <div class="col-12">
                                <img src="<?=base_url('assets/dist/img/bgdasbor.png')?>" alt="background image"
                                ...
                                <div class="col-lg-4 col-12">
                                    <!-- small box --><a href="<?=site_url('dashboard/mainpackage')?>">
                                        <div class="small-box bg-success" style="height: 120px;">
                                            <div class="inner">
                                                <h6 style="text-align:center; padding-top:35px;">Main
                                                    Package<br>(Slimming/Healthy/Other)</h6>
                                            </div>
                        ...
                        <div class="col-lg-4 col-12">
                            <!-- small box --><a href="<?=site_url('BlastCustomer')?>">
                                <div class="small-box bg-warning" style="height: 120px;">
                                    <div class="inner">
                                        <h6 style="text-align:center; padding-top:35px;">Blast Customer for stop
                                            temporary delivery</h6>
                                    </div>
                                    <!-- <a href="main-package.html" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a> -->
                                </div>
                        </div></a>
