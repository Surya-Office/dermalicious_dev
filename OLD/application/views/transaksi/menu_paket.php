                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <!-- <div id="map"></div> -->
                      <!-- <div ></div> -->
                      <iframe id="maps-1" class="form-control form-control-lg" src="" style="height: 250px;" frameborder="0"></iframe>
                      ...
                      <div class="row">
                        <div class="col-6">
                          <div class="form-group">
                            ...
                            <textarea class="form-control" rows="3" id="alamat-2" name="alamat_2" required placeholder="Nama Jalan ..."></textarea>
                          </div>
                          <div class="row">
                            <div class="col-6">
                              <div class="form-group">
                          ...
                          <div class="row">
                            <div class="col-6">
                              ...
                              <label>Google Maps</label>
                                ...
                                <iframe id="maps-2" class="form-control form-control-lg" src="" style="height: 250px;" required frameborder="0"></iframe>
                        ...
                        <div class="col-6">
                          <div class="form-group">
                            ...
                            <textarea class="form-control" rows="3" id="alamat-3" name="alamat_3" required placeholder="Nama Jalan ..."></textarea>
                          </div>
                          <div class="row">
                            <div class="col-6">
                              <div class="form-group">
                          ...
                          <div class="row">
                            <div class="col-6">
                              <div class="form-group">
                                ...
                                <iframe id="maps-3" class="form-control form-control-lg" src="" style="height: 250px;" required frameborder="0"></iframe>
                            ...
                            <div class="col-6">
                              <div class="form-group">
                                <label>Catatan Pengiriman</label>
                                <input class="form-control form-control-lg" type="text" name="notepengiriman_3" required placeholder="" style="height: 250px;">
                              </div>
                            </div>
                          </div>
