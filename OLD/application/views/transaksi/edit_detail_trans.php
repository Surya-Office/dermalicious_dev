...
<head>
  ...
  <title>Customer Detail - Add</title>
          ...
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="button-create">
                <a href="customer-detail.html" class="btn btn-primary" role="button" style="margin-left: -12px;"> <i
                    class="fas fa-reply">
                  </i>
                </a>
              </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <!-- <div class="input-group date" id="reservationdate" data-target-input="nearest"> -->
                        <input type="text" class="form-control datetimepicker-input" data-target="#reservationdate" name="start_date_periode" id="start_date_periode" value="<?=$detail_transaksi->start_date_periode_paket?>" readonly />
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <!-- <div class="input-group date" id="reservationdate2" data-target-input="nearest"> -->
                        <input type="text" class="form-control" readonly name="end_date_periode" id="end_date_periode" value="<?=$detail_transaksi->end_date_periode_paket?>" />
                  ...
                  <div class="col-12">
                    <div class="btn btn-group">
                      <div class="row">
                        <div class="col-md-6">
                          <div class="btn btn-group">
                            <a href="customer-detail.html"><button type="button"
