                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          <label>ID User</label>
                          <input class="form-control" value="<?=$transaksi->id_user?>" type="text" name="id_user">
                        </div>
                      </div>
                      <div class="col-md-6">
                        <div class="form-group">
                              ...
                              foreach ($detail_transaksi as $key) {?>
                                ...
                                <td>
                                  <div class="btn-group btn-group-xs">
                                    ...
                                    <a href="<?=site_url('transaksi/editdetailtransaksi/'.$key['id_transaksi'].'/'.$key['id_transaksi_detail'])?>" class="btn btn-warning" data-toggle="tooltip" title="Create"><i
