...
class TransaksiModel extends CI_Model
{
    ...
    public function insertInvoice($qty_total, $detailpaket, $id_trans)
    {
        ...
        $time_transaksi = date("H:i", strtotime($this->session->userdata('waktu_transaksi')));
        ...
        if ($time_paid >= "18:00") {
            ...
            $tgl_pengiriman = date('Y-m-d', strtotime($date_paid. '+ 2 days'));
        }

        //   $total_detail_paket = json_encode($detailpaket);
          $total_detail_paket=  implode('<br> ', array_map(function ($entry) {
    ...
    public function insertDetailInvoice($id_trans)
    {
        ...
        foreach ($cart as $key) {
            ...
            if ($key['detail_alamat']['kota_1'] == "") {
                ...
                $kota_1=$key['detail_alamat']['kota_1'];
                $kelurahan_1=$key['detail_alamat']['kelurahan_1'];
                $kecamatan_1=$key['detail_alamat']['kecamatan_1'];
            }
            if ($key['detail_alamat']['kota_2'] == "") {
                ...
                $kota_2=$key['detail_alamat']['kota_2'];
                $kelurahan_2=$key['detail_alamat']['kelurahan_2'];
                $kecamatan_2=$key['detail_alamat']['kecamatan_2'];
            }
            if ($key['detail_alamat']['kota_3'] == "") {
                ...
                $kota_3=$key['detail_alamat']['kota_3'];
                $kelurahan_3=$key['detail_alamat']['kelurahan_3'];
                $kecamatan_3=$key['detail_alamat']['kecamatan_3'];
            }
            $data = array(
                'id_transaksi' => $id_trans,
                'id_customer' => $this->session->userdata('id_cust'),
